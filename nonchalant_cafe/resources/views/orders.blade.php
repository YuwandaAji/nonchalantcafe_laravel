    ...
    <div class="grid-container">
        ...
        <main class="main-container">
            ...
            <div class="main-list">
                ...
                <a href="admin_order_detail.html" class="list">
                    <div class="inner-list">
                        <img src="americano.jpg" alt="image-item">
                        <div class="inner-list-text">
                            <span class="item">Hot Americano</span>
                            <div class="preview">
                                <span>Id Pesanan: 001</span>
                                <span>Customer: Aji</span>
                                <span>1 Produk</span>
                            </div>
                        </div>
                    </div>
